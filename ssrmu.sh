...
Download_SSR(){
	cd "/usr/local"
	wget -N --no-check-certificate "https://raw.githubusercontent.com/uu1414oo1414/ssr_subscrible_tool/master/manyuser.zip"
...
if [[ "${action}" == "clearall" ]]; then
	...
	echo -e "  ShadowsocksR ddtljz一键管理脚本 ${Red_font_prefix}[v${sh_ver}]${Font_color_suffix}
  ---- ddtljz ----
